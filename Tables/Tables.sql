...
category_id number constraint category_id_fk references categories(category_id) not null,
...
car_id number constraint rentals_car_id_fk references cars(car_id) not null,
customer_id number constraint customer_id_fk references customers(customer_id) not null,
...
car_id number constraint service_log_car_id_fk references cars(car_id) NOT NULL,
